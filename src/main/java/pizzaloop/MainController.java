...
public class MainController {
    ...
    */
    ...
    public @ResponseBody String addNewOrder(@RequestParam String name, @RequestParam String imageUrl, @RequestParam Double price) {
    ...
    */
    ...
    public @ResponseBody List<OrderDetails> deleteCartById(@RequestParam Integer id) {
        return orderRepository.deleteByCartId(id);
    }
